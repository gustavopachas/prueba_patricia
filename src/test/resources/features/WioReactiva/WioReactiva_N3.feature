Feature: Solicitud de Pagare Reactiva-N3
  ...
  @EscenarioN3_AsistenteComercial
  Scenario Outline: Estacion Elaboración Instruccion
    ...
    Examples:
      | Data | Perfil2             | IO                 |
      | 1    | Asistente Comercial | 000000002000211376 |


  @EscenarioN3_EjecutivoDeNegocio
  Scenario Outline: Estacion Aprobación Instruccion
    ...
    Examples:
      | Data | Perfil3              | IO         |
      | 1    | Ejecutivo de Negocio | 2000212187 |


  @EscenarioN3_AsistenteDeCC_N1
  Scenario Outline: Estacion Verificación De Documentos N1
    ...
    Examples:
      | Data | Perfil4                          | IO         |
      | 1    | Asistente de Control de Creditos | 2000212187 |


  @EscenarioN3_SupervisorDeCC_N2
  ...
  Scenario Outline: Estacion Verificacion De Documentos N3
    ...
    Examples:
      | Data | Perfil6                     | IO                 |
      | 3    | Jefe de Control de Créditos | 000000002000212609 |